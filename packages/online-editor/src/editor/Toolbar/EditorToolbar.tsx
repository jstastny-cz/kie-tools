    ...
    () =>
      ...
      props.workspace.files.length +
        listDeletedFiles({
          ...
          workspaceGitStatus: props.workspaceGitStatusPromise.data,
        }).length >
        1,
    [props.workspace.descriptor, props.workspace.files.length, props.workspaceGitStatusPromise.data]
  );
            ...
            <PageHeaderToolsItem visibility={{ default: "visible" }}>
              <Flex flexWrap={{ default: "nowrap" }} alignItems={{ default: "alignItemsCenter" }}>
                <FlexItem style={{ minWidth: 0 }}>
                  <FileSwitcher
                    workspace={props.workspace}
                    workspaceGitStatusPromise={canSeeWorkspaceToolbar ? props.workspaceGitStatusPromise : undefined}
                    workspaceFile={props.workspaceFile}
                    onDeletedWorkspaceFile={handleDeletedWorkspaceFile}
                  />
                </FlexItem>
